...
class ProductTemplate(models.Model):
    ...
    def _get_combination_info(self, combination=False, product_id=False, add_qty=1, pricelist=False,
        ...
        price_extra = res.get('price_extra', 0)
        if pricelist and price_extra > 0:
            price_extra = price_extra - (price_extra * pricelist.discount_attribute / 100)
            res['price_extra'] = price_extra
        return res
